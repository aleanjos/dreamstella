...
public:
  ...
  */
  void toggleP0Bit() const { toggleTIABit(0, "P0"); }
  void toggleP1Bit() const { toggleTIABit(1, "P1"); }
  void toggleM0Bit() const { toggleTIABit(2, "M0"); }
  void toggleM1Bit() const { toggleTIABit(3, "M1"); }
  void toggleBLBit() const { toggleTIABit(4, "BL"); }
  void togglePFBit() const { toggleTIABit(5, "PF"); }
  ...
  */
  void toggleP0Collision() const { toggleTIACollision(0, "P0"); }
  void toggleP1Collision() const { toggleTIACollision(1, "P1"); }
  void toggleM0Collision() const { toggleTIACollision(2, "M0"); }
  void toggleM1Collision() const { toggleTIACollision(3, "M1"); }
  void toggleBLCollision() const { toggleTIACollision(4, "BL"); }
  void togglePFCollision() const { toggleTIACollision(5, "PF"); }
...
private:
  ...
  */
  ...
  void toggleTIABit(int bit, const string &bitname, bool show = true) const;
  void toggleTIACollision(int bit, const string &bitname, bool show = true) const;
...
private:
  ...
  static uInt32 ourNTSCPalette[512];
  static uInt32 ourPALPalette[512];
  static uInt32 ourSECAMPalette[512];

  // Table of RGB values for NTSC, PAL and SECAM - Z26 version
  static uInt32 ourNTSCPaletteZ26[512];
  static uInt32 ourPALPaletteZ26[512];
  static uInt32 ourSECAMPaletteZ26[512];
