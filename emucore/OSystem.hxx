...
public:
 ...
 void pause() { myPauseLoop = true; }
 void frameRefresh() { myFrameRefresh = true;}
...
protected:
  ...
  // In game menu for Sega Dreamcast
  ...
  // Pointer cast for framebuffer for Dreamcast
  FrameBufferSoftDC *myFrameDc;
