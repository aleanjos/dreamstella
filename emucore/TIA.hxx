...
public:
  ...
  */
  ...
  /**
    ...
    @return  Whether the bit was enabled or disabled
  */
  bool toggleBit(int b) { return true; }
  bool toggleBits() { return true; }
  bool toggleCollision(int b) { return true; }
  bool toggleCollisions() { return true; }
