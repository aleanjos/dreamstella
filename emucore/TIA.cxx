...
void TIA::updateFrameScanline(uInt32 clocksToUpdate, uInt32 hpos)
{
  ...
  else
  {
    ...
    case PFBit | ScoreBit:
    {
      ...
      {
        *myFramePointer = (myPF & *mask) ? (hpos < 80 ? myCOLUP0 : myCOLUP1) : myCOLUBK;
      }
      ...
      {
        *((uInt32 *)myFramePointer) = (myPF & *mask) ? (hpos < 80 ? myCOLUP0 : myCOLUP1) : myCOLUBK;
      }
      break;
    }
    ...
    case P0Bit | P1Bit | ScoreBit | PriorityBit:
    {
      ...
      while (myFramePointer < ending)
      {
        ...
        {
          *myFramePointer = (myCurrentGRP0 & *mP0) ? myCOLUP0 : ((myCurrentGRP1 & *mP1) ? myCOLUP1 : myCOLUBK);
    ...
    case BLBit | P1Bit | ScoreBit:
    {
      ...
      while (myFramePointer < ending)
      {
        ...
        {
          *myFramePointer = (myCurrentGRP1 & *mP1) ? myCOLUP1 : (*mBL ? myCOLUPF : myCOLUBK);
    ...
    case BLBit | P1Bit | PriorityBit | ScoreBit:
    {
      ...
      while (myFramePointer < ending)
      {
        ...
        {
          *myFramePointer = *mBL ? myCOLUPF : ((myCurrentGRP1 & *mP1) ? myCOLUP1 : myCOLUBK);
    ...
    case PFBit | P0Bit:
    {
      ...
      while (myFramePointer < ending)
      {
        ...
        {
          *myFramePointer = (myCurrentGRP0 & *mP0) ? myCOLUP0 : ((myPF & *mPF) ? myCOLUPF : myCOLUBK);
    ...
    case PFBit | P0Bit | PriorityBit:
    {
      ...
      while (myFramePointer < ending)
      {
        ...
        {
          *myFramePointer = (myPF & *mPF) ? myCOLUPF : ((myCurrentGRP0 & *mP0) ? myCOLUP0 : myCOLUBK);
    ...
    case PFBit | P1Bit:
    {
      ...
      while (myFramePointer < ending)
      {
        ...
        {
          *myFramePointer = (myCurrentGRP1 & *mP1) ? myCOLUP1 : ((myPF & *mPF) ? myCOLUPF : myCOLUBK);
    ...
    case PFBit | P1Bit | PriorityBit:
    {
      ...
      while (myFramePointer < ending)
      {
        ...
        {
          *myFramePointer = (myPF & *mPF) ? myCOLUPF : ((myCurrentGRP1 & *mP1) ? myCOLUP1 : myCOLUBK);
...
inline uInt8 TIA::dumpedInputPort(int resistance)
{
  ...
  else
  {
    ...
    uInt32 needed = (uInt32)(1.216e-6 * resistance * myScanlineCountForLastFrame * myFramerate);
